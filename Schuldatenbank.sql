...
CREATE TABLE IF NOT EXISTS `ablegen` (
  `ID_Schüler` bigint(20) NOT NULL,
  `ID_Prüfung` bigint(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Ausübung` (
  `ID_Ausübung` bigint(20) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `Klasse` (
  ...
  `ID_Schüler` bigint(20) default NULL,
...
(2, 'IF2B', 2, 3, '2016-08-20'),
(3, 'IF2C', 7, 3, '2015-08-20'),
(4, 'IF2A', 13, 6, '2015-08-20');
...
CREATE TABLE IF NOT EXISTS `Prüfung` (
  `ID_Prüfung` bigint(20) NOT NULL auto_increment,
  `Datum` date default NULL,
...
(1, '2016-10-15', 3, 'Klassenarbeit', 3, 8),
(2, '2016-11-20', 1, 'Test', 3, 8),
(3, '2016-11-27', 2, 'Test', 3, 8),
(4, '2016-12-10', 3, 'Klassenarbeit', 3, 8),
(5, '2016-10-02', 3, 'Klassenarbeit', 5, 2),
(6, '2016-11-03', 1, 'Test', 5, 2),
(7, '2016-12-20', 2, 'Klassenatbeit', 5, 2),
(8, '2016-09-27', 3, 'Klassenarbeit', 7, 4),
(9, '2017-01-10', 3, 'Klassenarbeit', 7, 4);
...
CREATE TABLE IF NOT EXISTS `Schüler` (
  `ID_Schüler` bigint(20) NOT NULL auto_increment,
  `Nachname` varchar(50) default NULL,
  `Vorname` varchar(50) default NULL,
  `Straße` varchar(50) default NULL,
  `PLZ` varchar(5) default NULL,
...
(1, 'Müller', 'Simon', 'Am Meisterstein 37', '59955', 'Winterberg', '2001-06-07', 'Hauptschule', 2, 'A'),
(2, 'Schmidt', 'Sabine', 'Siepen 6', '59823', 'Arnsberg', '1999-12-14', 'Hauptschule', 2, 'A'),
(3, 'Specht', 'Christa', 'Immenhütten 16', '59929', 'Brilon', '2001-02-23', 'Realschule', 2, 'A'),
(4, 'Klein', 'Marcel', 'Grafschaft 23', '57392', 'Schmallenberg', '1999-08-04', 'Realschule', 2, 'B'),
(5, 'Groß', 'Paul', 'Höhenstraße 10', '59955', 'Winterberg', '2000-04-30', 'Hauptschule', 2, 'B'),
(6, 'Vogel', 'Alex', 'Ludwig-Straße 5', '59929', 'Brilon', '2001-03-13', 'Gymnasium', 2, 'B'),
(7, 'Janssen', 'Marc', 'Wolfsheid 27', '59469', 'Ense', '1998-02-19', 'Gymnasium', 3, 'A'),
(8, 'Meier', 'Ilyas', 'Mühlenweg 5', '59889', 'Eslohe', '1998-03-13', 'Hauptschule', 3, 'A'),
(9, 'Schulte', 'Claudia', 'Stembergstraße 32a', '59755', 'Arnsberg', '1999-11-08', 'Realschule', 3, 'A'),
(10, 'Kramer', 'Dirk', 'Schurrenweg 10', '59964', 'Medebach', '1999-02-21', 'Realschule', 3, 'B'),
(11, 'Schmidt', 'Oktay', 'Am Rad 22', '59955', 'Winterberg', '2000-01-09', 'Realschule', 3, 'B'),
(12, 'Müller', 'Steffen', 'Alter Weg 24', '59955', 'Winterberg', '1998-02-22', 'Hauptschule', 3, 'B'),
(13, 'Drees', 'Dominik', 'Oemberg 12', '59823', 'Arnsberg', '2000-11-16', 'Hauptschule', 4, 'A'),
(14, 'Hoff', 'Peter', 'Weidenstraße 46', '59872', 'Meschede', '2000-08-24', 'Realschule', 4, 'A'),
(15, 'Elsner', 'Dirk', 'An der Ziegelei 31', '34431', 'Marsberg', '2001-02-22', 'Realschule', 4, 'A'),
(16, 'Vogt', 'David', 'Vinckestraße 55', '59821', 'Arnsberg', '2000-08-02', 'Hauptschule', 4, 'B'),
(17, 'Martin', 'Patrick', 'Gartenstraße 8a', '59909', 'Bestwig', '2001-04-14', 'Realschule', 4, 'B'),
(18, 'Müller', 'Eva', 'Rabenweg 3', '59823', 'Arnsberg', '2000-02-07', 'Gymnasium', 4, 'B'),
